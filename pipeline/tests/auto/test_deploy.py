...
class TestDeployVercel:
    ...
    def test_successful_deploy(self, mock_http, mock_run, temp_repo):
    ...
    def test_no_package_json_skips(self, temp_repo):
        # Remove package.json
    ...
    @patch("src.auto.deploy._run_command")
    def test_no_vercel_cli_skips(self, mock_run, temp_repo):
    ...
    @patch("src.auto.deploy._run_command")
    @patch("src.auto.deploy._http_get")
    def test_smoke_test_fails(self, mock_http, mock_run, temp_repo):
        mock_run.side_effect = [
            (0, "33.0.0", ""),
...
class TestDeployPrefect:
    ...
    def test_successful_deploy(self, mock_run, temp_repo):
        mock_run.side_effect = [
    ...
    def test_no_prefect_yaml_skips(self, temp_repo):
    ...
    @patch("src.auto.deploy._run_command")
    def test_missing_env_vars_skips(self, mock_run, temp_repo):
    ...
    def test_deploy_failure(self, mock_run, temp_repo):
        mock_run.side_effect = [
            (0, "3.0.0", ""),
...
class TestDeployRouter:
    def test_routes_to_vercel(self, temp_repo):
    ...
    def test_routes_to_prefect(self, temp_repo):
    ...
    def test_invalid_target_raises(self, temp_repo):
        try:
