...
class TestAutoFix:
    ...
    def test_tier_2_all_clean_first_attempt(self, mock_ruff, mock_pytest):
    ...
    @patch("src.auto.fix._run_pytest")
    @patch("src.auto.fix._run_ruff")
    def test_tier_2_pytest_fails_then_fixed(self, mock_ruff, mock_pytest):
    ...
    @patch("src.auto.fix._run_pytest")
    @patch("src.auto.fix._run_ruff")
    def test_tier_2_always_fails(self, mock_ruff, mock_pytest):
    ...
    def test_tier_1_all_clean(self, mock_lint, mock_build):
    ...
    @patch("src.auto.fix._run_npm_build")
    @patch("src.auto.fix._run_npm_lint")
    def test_tier_1_build_fails(self, mock_lint, mock_build):
    ...
    @patch("src.auto.fix._run_pytest")
    @patch("src.auto.fix._run_ruff")
    def test_max_attempts_respected(self, mock_ruff, mock_pytest):
    ...
    def test_directive_preserved(self):
...
class TestQuickFixes:
    ...
    def test_no_fixes_applicable(self):
        from src.auto.fix import _apply_quick_fixes
