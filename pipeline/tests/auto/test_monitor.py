...
class TestMonitorVercel:
    ...
    def test_all_healthy(self, mock_http):
    ...
    @patch("src.auto.monitor._http_get")
    def test_main_url_fails(self, mock_http):
    ...
    @patch("src.auto.monitor._http_get")
    def test_health_endpoint_404_warn(self, mock_http):
        mock_http.side_effect = [
            (200, None, ""),  # main_url
...
class TestMonitorPrefect:
    ...
    def test_env_present(self, mock_run):
