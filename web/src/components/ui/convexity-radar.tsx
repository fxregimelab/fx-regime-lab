              ...
              <li key={key} className="bg-[#000000]">
                ...
                >
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="truncate font-mono text-[13px] text-white tabular-nums">
                      {event.event}
                    </div>
                  </div>
                  <div className="flex flex-wrap items-center gap-2 sm:justify-end">
                    ...
                    >
                      MIE×RV20{" "}
                      {matrix?.median_mie_multiplier != null
                        ? formatNum(matrix.median_mie_multiplier)
                        : "—"}
                    </span>
                    {lowSample ? (
                  ...
                  <div className="border-t border-[#111] bg-[#000000] px-4 pb-4 pt-2">
                    {lowSample && (
                      <div className="mb-4 border border-[#2a2214] bg-[#ef444422] px-3 py-2 font-mono text-[11px] tracking-widest text-[#fcd34d] tabular-nums">
                        N &lt; 5 · VOLATILITY PROFILE ONLY (NO DIRECTIONAL
                        BUCKETS)
                      </div>
                    )}
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                      <div className="border border-[#141414] bg-[#000000] px-3 py-2">
                        <p className="font-mono text-[9px] tracking-widest text-[#666]">
                          SAMPLE (REGIME-MATCHED)
                        </p>
                        <p className="font-mono text-[14px] text-white tabular-nums">
                          N = {n}
                        </p>
                      </div>
                      <div className="border border-[#141414] bg-[#000000] px-3 py-2">
                        <p className="font-mono text-[9px] tracking-widest text-[#666]">
                          MEDIAN MIE MULTIPLIER
                        </p>
                        <p
                          className={`font-mono text-[14px] tabular-nums text-white ${mathStrike}`}
                        >
                          {matrix?.median_mie_multiplier != null
                            ? formatNum(matrix.median_mie_multiplier)
                            : "—"}
