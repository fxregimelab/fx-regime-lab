...
export function Nav() {
  ...
  return (
    <header className="border-b border-[#e5e5e5] bg-white sticky top-0 z-[90]">
      <nav className="max-w-[1152px] mx-auto px-6 h-[54px] flex items-center justify-between">
        <Link href="/" className="flex items-center h-[54px] shrink-0">
          <LogoMark size={24} />
        </Link>
          ...
          >
            ...
            >
              ...
              <svg
                ...
                viewBox="0 0 10 6"
                fill="none"
                className={`opacity-50 transition-transform duration-150 ${open ? "rotate-180" : ""} group-hover:rotate-180`}
              >
                <path
                  d="M1 1l4 4 4-4"
                  stroke="currentColor"
            ...
            <div
              className={`absolute right-0 top-[54px] bg-[#050505] border border-[#1a1a1a] min-w-[180px] shadow-none z-[1000] transition-all duration-150 ${
                open
                  ? "opacity-100 visible"
            ...
            >
              {[
                ...
                const isLocked =
                  href === "/performance" || href === "/strategy";
                if (isLocked) {
                  return (
                    <div
                      key={href}
                    ...
                    >
                      <span>{label}</span>
                      <span className="text-[9px] font-mono tracking-widest text-[#444]">
                        [ LOCKED ]
                      </span>
                    </div>
                  );
