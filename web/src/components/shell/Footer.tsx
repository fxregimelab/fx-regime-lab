    ...
    <footer className="border-t border-[var(--color-border)] bg-[var(--color-void)]">
      <div className="max-w-[1152px] mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-12">
          <div>
            <p className="font-mono text-[11px] tracking-[0.2em] text-[var(--color-text)] uppercase font-medium mb-3">
              FX Regime Lab
            </p>
            <p className="font-sans text-[13px] text-[var(--color-text-secondary)] leading-relaxed max-w-[320px]">
        ...
        <div className="mt-16 pt-6 border-t border-[var(--color-border)] flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
          <p className="font-mono text-[10px] text-[var(--color-text-dim)] tracking-wider">
