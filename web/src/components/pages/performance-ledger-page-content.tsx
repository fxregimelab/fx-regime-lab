...
export function PerformanceLedgerPageContent() {
  ...
  return (
    <section className="w-full px-6 md:px-8 py-10 shadow-none">
      <p className="mb-2 font-mono text-[9px] tracking-widest text-[#777]">ALPHA LEDGER · OOS</p>
      <h1 className="mb-1 font-sans text-3xl font-bold text-white shadow-none">Performance</h1>
      <p className="mb-6 font-mono text-[11px] tracking-wide text-[#8a8a8a] shadow-none">
        Regime-cycle grouped forward-walking ledger (non-neutral). Thermal tint from T+5 resolution.
      </p>
      ...
      {ledgerQ.isPending ? (
        ...
        <p className="font-mono text-sm text-[#ef4444] shadow-none">Could not load strategy ledger.</p>
      ) : (
