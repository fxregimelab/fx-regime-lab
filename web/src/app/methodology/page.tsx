  ...
  return (
    <div className="min-h-screen bg-[var(--color-cream)]">
      ...
      <main className="max-w-[1152px] mx-auto px-6 pt-28 pb-20 w-full">
        <div className="reveal mb-10 pb-6 border-b border-[var(--color-stone-200)]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-12">
          <div>
            <div className="reveal">
              <h2 className="font-sans font-semibold text-xl text-[var(--color-stone-800)] tracking-tight mb-4">
                Composite Score
              </h2>
              <p className="font-sans text-[15px] text-[var(--color-stone-500)] leading-[1.7] mb-6">
              ...
              <p className="font-sans text-[15px] text-[var(--color-stone-500)] leading-[1.7] mb-10">
                where{" "}
                <span className="font-mono text-sm text-[var(--color-stone-800)]">
                  w_r ≈ 0.40
                </span>
                ,{" "}
                <span className="font-mono text-sm text-[var(--color-stone-800)]">
            ...
            <div className="reveal">
              ...
              <div className="border border-[var(--color-stone-200)] mb-10">
                <table className="w-full border-collapse font-mono text-[11px]">
                  <thead>
                    <tr className="border-b border-[var(--color-stone-200)] bg-[var(--color-parchment)]">
                      <th className="px-4 py-2.5 text-left text-[var(--color-stone-400)] tracking-[0.1em]">
                        REGIME
                      </th>
                      <th className="px-4 py-2.5 text-left text-[var(--color-stone-400)] tracking-[0.1em]">
                        COMPOSITE RANGE
                  ...
                  <tbody>
                    {[
                      ...
                      <tr
                        key={regime}
                        className="border-b border-[var(--color-stone-100)] last:border-b-0"
                      >
                        <td className="px-4 py-2.5 text-[var(--color-stone-800)] font-medium">
                          {regime}
                        </td>
                        <td className="px-4 py-2.5 text-[var(--color-stone-500)]">
                          {range}
                        </td>
                      </tr>
                    ))}
            ...
            <div className="reveal">
              ...
              <p className="font-sans text-[15px] text-[var(--color-stone-500)] leading-[1.7]">
                where{" "}
                <span className="font-mono text-sm text-[var(--color-stone-800)]">
                  σ_signals
                </span>{" "}
          ...
          <div>
            <div className="reveal sticky top-[80px] border border-[var(--color-stone-200)] p-6 bg-white">
              <p className="font-mono text-[10px] tracking-[0.15em] text-[var(--color-stone-400)] uppercase mb-6">
                Signal Families
              </p>
                ...
                {[
                  ...
                  <div key={fam.label}>
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="font-sans font-semibold text-sm text-[var(--color-stone-800)]">
                        {fam.label}
                      </span>
                    </div>
                    <p className="font-sans text-[13px] text-[var(--color-stone-500)] leading-relaxed mb-2">
                      {fam.desc}
                    </p>
                    <div className="flex flex-col gap-1">
                      {fam.stats.map(([k, v]) => (
                        ...
                        >
                          <span className="text-[var(--color-stone-400)] tracking-wider">
                            {k.toUpperCase()}
                          </span>
